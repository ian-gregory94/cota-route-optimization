...
## 1. through-route 002 and 033 at WESHIGW, a stop within 3 stops of both routes' terminals, removing a forced transfer for riders crossing it
...
## 3. through-route 005 and 021 at NMURBEAN, a stop within 3 stops of both routes' terminals, removing a forced transfer for riders crossing it
...
## 5. through-route 007 and 101 at EMO4THW, a stop within 3 stops of both routes' terminals, removing a forced transfer for riders crossing it
...
## 6. through-route 006 and 021 at NMURBEAN, a stop within 3 stops of both routes' terminals, removing a forced transfer for riders crossing it

- **id** `splice|006|021|NMURBEAN` · **kind** splice · **routes** 006+021
- **evidence** primary, 1.0% of segments priced by the running-time model (2 of 206)
- **supply** -0.5 vehicle-hours at baseline (52.5 → 78.4 min per pattern, +49.4%); headways then rescaled ×1.0002 to spend the budget back
- **stops** −0 / +0; 0 would lose their only service; 0 affected stops are served by more than one route
- **demand reached** 0 gained, 0 lost (uniquely-served weight)
- **service today** mean headway 67.1 min across 12 route-periods, best 14.4 min
- **screen** cost -0.264%, unserved -0.046% (frequency not reallocated — a rank, not a measurement)
- **planner would object**: nothing flagged

![before and after](figures/candidates/splice_006_021_NMURBEAN.light.svg)
